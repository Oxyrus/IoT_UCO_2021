...
const int mqttPort = 10345;
const char* mqttUser = "yvnemooa";
const char* mqttPassword = "lxqM-EuIHmjL";
const char* TopicSub = "esp";
const char* TopicPub = "jgv";
...
void loop() {
  ...
  if(digitalRead(D0)==0)
  {
    Serial.print("Alarmed!");
    client.publish(TopicPub, "Alarm!!!");
    delay(1000);
  } else {
    Serial.print("OK");
    delay(1000);
